...
const REVEAL_CONTENT = [
  {
    upper: ["name: un1xpected", "age: 15"],
    lower: "major: computer science — passion: shell scripting & kernel dev",
  },
  {
    upper: [
...
const ITEMS = [
  {
    id: "aboutme", label: "ABOUT ME", handle: "@un1xpected", href: "https://github.com/un1xpected", icon: "👤", barIcon: icon1, bars: 1, newBars: [0], counts: ["—"],
    links: ["github.com/un1xpected"],
    stats: [
      { tag: "AGE", value: "15", color: "#9147ff" },
      { tag: "LVL", value: "∞",  color: "#bf94ff" },
    ],
  },
  {
    id: "funfact", label: "FUN FACT ABOUT ME", handle: "@un1xpected", href: "https://github.com/un1xpected", icon: "💡", barIcon: icon2, bars: 3, newBars: [0], counts: ["—", "—", "—"],
    links: ["github.com/un1xpected", "github.com/un1xpected", "github.com/un1xpected"],
    stats: [
      { tag: "IQ", value: "???", color: "#e1306c" },
      { tag: "XP", value: "MAX",  color: "#f77737" },
    ],
  },
  {
    id: "wired", label: "WIRED FACT ABOUT ME", handle: "@un1xpected", href: "https://github.com/un1xpected/chronos", icon: "⚡", barIcon: icon3, bars: 3, newBars: [0], counts: ["—", "—", "—"],
    links: ["github.com/un1xpected/chronos", "github.com/un1xpected/chronos", "github.com/un1xpected/chronos"],
    stats: [
      { tag: "REP", value: "—", color: "#00f2ea" },
      { tag: "STR", value: "—",  color: "#ff0050" },
    ],
  },
];
